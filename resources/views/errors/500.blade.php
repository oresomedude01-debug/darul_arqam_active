...
<head>
    ...
    <style>
        ...
        .error-code {
            font-size: 5rem;
            font-weight: 900;
            background: linear-gradient(135deg, #fa709a, #fed373);
...
<body>
    <div class="error-container">
        ...
        <div class="error-details">
            <h4>What happened?</h4>
            <p>
                An unexpected error occurred while processing your request. Our team has been notified and is investigating the issue.
            </p>
        </div>
