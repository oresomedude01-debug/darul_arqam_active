        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600">Add a new role to the system</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <form action="{{ route('roles.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description" name="description" rows="3"
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
