    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-amber-500">
                <h1 class="text-4xl font-bold text-gray-900 mb-2">Edit Event</h1>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <form method="POST" action="{{ route('events.update', $event) }}" class="p-8">
                @csrf
                @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" 
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                                      placeholder="Add any additional details, requirements, or notes about this event...">{{ old('description', $event->description) }}</textarea>
                            @error('description')
                                <div class="mt-2 text-red-600 text-sm">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="color" id="color" name="color" value="{{ old('color', $event->color) }}" 
                                    ...
                                    <div>
                                        ...
                                        <input type="text" value="{{ old('color', $event->color) }}" 
                    ...
                    <div class="space-y-6">
                            ...
                            <select id="academic_term_id" name="academic_term_id" 
                                ...
                                @foreach($academicTerms as $term)
                                    <option value="{{ $term->id }}" 
                                            {{ old('academic_term_id', $event->academic_term_id) === (string)$term->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <div class="border-2 border-gray-300 rounded-lg p-4 max-h-48 overflow-y-auto bg-gray-50">
                                @php
                                    $selectedClasses = old('affected_classes', 
                                        $event->affected_classes ? json_decode($event->affected_classes, true) : []
                                    );
                                @endphp
                                @if($classes->count() > 0)
                                    <div class="space-y-3">
